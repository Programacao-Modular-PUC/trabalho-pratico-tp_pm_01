        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-amber-400 selection:text-black antialiased">
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <a href="#desenvolvedores" className="px-10 py-5 bg-white/5 border border-white/10 font-black rounded-2xl hover:bg-white/10 transition backdrop-blur-md">
                                Conhecer equipe
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 relative">
                        <div className="space-y-4 pt-12">
                            <img src="/img/praia_de_taipu_de_fora.jpg" className="rounded-[2.5rem] h-80 w-full object-cover border border-white/10 shadow-2xl" alt="Praia" />
                            <img src="/img/praia_do_cassange.jpg" className="rounded-[2.5rem] h-56 w-full object-cover border border-white/10 shadow-2xl" alt="Lagoa" />
                        </div>
                        <div className="space-y-4">
                            <img src="/img/praia-do-muta.jpg" className="rounded-[2.5rem] h-56 w-full object-cover border border-white/10 shadow-2xl" alt="Pôr do sol" />
                            <img src="/img/praia_de_tres_coqueiros.jpg" className="rounded-[2.5rem] h-80 w-full object-cover border border-white/10 shadow-2xl" alt="Corais" />
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-6 py-32 space-y-32">
                <section className="text-center">
                    ...
                    <p className="text-lg text-gray-400 leading-relaxed max-w-4xl mx-auto font-medium">
                ...
                <section id="tecnologias" className="grid lg:grid-cols-2 gap-20 items-center">
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div className="bg-[#111] border border-white/10 p-6 rounded-[2rem] hover:bg-white/5 transition">
                                ...
                                <p className="text-gray-500 text-sm font-medium">React + Vite + Tailwind CSS</p>
                            </div>
                            ...
                            <div className="bg-[#111] border border-white/10 p-6 rounded-[2rem] hover:bg-white/5 transition">
                                ...
                                <p className="text-gray-500 text-sm font-medium">Spring Boot (Java)</p>
                            </div>
                            ...
                            <div className="bg-[#111] border border-white/10 p-6 rounded-[2rem] hover:bg-white/5 transition">
                                ...
                                <p className="text-gray-500 text-sm font-medium">MySQL</p>
                            </div>
                            ...
                            <div className="bg-[#111] border border-white/10 p-6 rounded-[2rem] hover:bg-white/5 transition">
                                ...
                                <p className="text-gray-500 text-sm font-medium">REST API + MVC</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-br from-[#111] to-[#080808] border border-white/5 p-10 rounded-[4rem] relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-gray-300 font-medium">Programação Orientada a Objetos</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <CheckCircle className="text-amber-400" size={20} />
                                    <span className="text-gray-300 font-medium">API RESTful</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <CheckCircle className="text-amber-400" size={20} />
                                    <span className="text-gray-300 font-medium">Persistência em Banco Relacional</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <CheckCircle className="text-amber-400" size={20} />
                                    <span className="text-gray-300 font-medium">Interface Responsiva</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <CheckCircle className="text-amber-400" size={20} />
                                    <span className="text-gray-300 font-medium">Arquitetura Desacoplada</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="desenvolvedores" className="text-center">
                    ...
                    <p className="text-gray-400 leading-relaxed text-lg mb-16 font-medium max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        <div className="bg-[#111] border border-white/10 p-8 rounded-[2rem] hover:bg-white/5 transition">
                            ...
                            <p className="text-gray-500 text-sm font-medium">Responsável pelo desenvolvimento completo da aplicação web e integração com back-end</p>
                        </div>
                        <div className="bg-[#111] border border-white/10 p-8 rounded-[2rem] hover:bg-white/5 transition">
                            <div className="w-24 h-24 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full mx-auto mb-6 flex items-center justify-center overflow-hidden">
                            ...
                            <p className="text-amber-400 text-sm font-medium mb-3">Desenvolvedor Full-Stack</p>
                            <p className="text-gray-500 text-sm font-medium">Responsável pelo desenvolvimento completo da aplicação web e integração com back-end</p>
                        </div>                        <div className="bg-[#111] border border-white/10 p-8 rounded-[2rem] hover:bg-white/5 transition">
                            <div className="w-24 h-24 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full mx-auto mb-6 flex items-center justify-center overflow-hidden">
                ...
                <section className="bg-gradient-to-br from-[#111] to-[#080808] border border-white/5 p-10 md:p-20 rounded-[4rem] relative overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-amber-400/5 blur-[100px] rounded-full"></div>
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-white font-bold mb-1">Aplicação de POO</h4>
                                        <p className="text-gray-500 text-sm">Implementar conceitos de orientação a objetos em um projeto real</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-white font-bold mb-1">Desenvolvimento Full-Stack</h4>
                                        <p className="text-gray-500 text-sm">Criar uma aplicação completa com front-end e back-end integrados</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-white font-bold mb-1">Persistência de Dados</h4>
                                        <p className="text-gray-500 text-sm">Implementar sistema de banco de dados relacional</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-400 font-medium">Programação Modular - Engenharia de Software</p>
                        </div>
                    </div>
                </section>
            </main>
