            ...
            <header className="relative pt-40 pb-24 lg:pt-56 lg:pb-40 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="relative z-10">
                        <Link to="/destinos" className={`inline-flex items-center gap-2 text-amber-400 transition mb-8 ${t.linkAccent}`}>
                            <ArrowLeft size={20} />
            ...
            <main className="max-w-7xl mx-auto px-6 pb-32">
                <div className="grid lg:grid-cols-2 gap-20 items-center mb-20">
                    <div>
                        ...
                        <p className={`${t.muted} leading-relaxed text-lg mb-8 font-medium`}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <img src="/img/praia_de_taipu_de_fora.jpg" className={`rounded-[2rem] h-48 w-full object-cover ${t.imageBorder}`} alt="Praia" />
                        <img src="/img/praia_do_cassange.jpg" className={`rounded-[2rem] h-48 w-full object-cover ${t.imageBorder} mt-8`} alt="Natureza" />
                        <img src="/img/praia-do-muta.jpg" className={`rounded-[2rem] h-48 w-full object-cover ${t.imageBorder} -mt-8`} alt="Mar" />
                        <img src="/img/praia_barra_grande.jpg" className={`rounded-[2rem] h-48 w-full object-cover ${t.imageBorder}`} alt="Vila" />
                    </div>
                </div>
