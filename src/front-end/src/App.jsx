      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-black/60 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter uppercase">Maraú<span className="text-amber-400">Reserve</span></span>
          </div>
          <div className="hidden md:flex items-center gap-10 text-[13px] font-bold uppercase tracking-widest">
            <div className="flex gap-8 text-gray-400">
              ...
              <a href="#hospedagem" className="hover:text-amber-400 transition">Hospedagens</a>
